...
const defaultSourcePath = new URL('../.env.example', import.meta.url);
const defaultTargetPath = new URL('../.env', import.meta.url);
const generatedPlaceholderValues = new Map([
    [
        'MAGICSSO_JWT_SECRET',
        new Set(['replace-me-with-a-long-random-jwt-secret', 'VERY-VERY-LONG-RANDOM-JWT-SECRET']),
    ],
